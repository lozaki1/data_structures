...
class FileSys{
    ...
    ******************************************/
    ...
    //Name: FileSys - reHash()
    //Precondition: Load faction is greater than 50% or deleted ratio is greater than 80%
    //Postcondition: Creates new table and scans data 25% at a time to transfer from old table to new table
    void reHash();
    void insertHash(File file); // helper function for reHash()
};
