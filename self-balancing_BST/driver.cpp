...
int main(){
    ...
    */
   Swarm team(AVL);
   Robot robot1(83125, BIRD);
   Robot robot2(79418, BIRD);
   Robot robot3(78447, BIRD);
   Robot robot4(78891, BIRD);
   Robot robot5(77390, BIRD);
   Robot robot6(84872, BIRD);
   Robot robot7(83494, BIRD);
   Robot robot8(92599, BIRD);
   Robot robot9(95805, BIRD);
   Robot robot10(88981, BIRD);
   Robot robot11(84346, BIRD);
   Robot robot12(80085, BIRD);
   team.insert(robot1);
   team.insert(robot2);
   team.insert(robot3);
   team.insert(robot4);
